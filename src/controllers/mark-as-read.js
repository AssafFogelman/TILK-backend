...
export const markAsRead = async (c) => {
    try {
        ...
        await db
            ...
            .set({ unread: false })
            .where(and(eq(connectionRequests.recipientId, userId), inArray(connectionRequests.senderId, requestingUsersArray)));
        ...
        return c.json({ message: "Error marking connection requests as read", error }, 401);
    }
};
